...
public class Main {
    ...
    public static void main(String... s) {
        ...
        List<String> macroLines = TGS_ListUtils.of(
                "INSERT_PAGE A4 PORTRAIT",
                "BEGIN_TEXT LEFT",
                "ADD_TEXT Merhaba Gardaş",
                "END_TEXT"
        );
        ...
        TGS_Url favIconPng = TGS_Url.of("https://localhost:8443/res-other/res/mesametal_com/favicon/mesametal-dark-16x16.png");
        String domainName = "localhost";
        TGS_CallableType1<TGS_Url, TGS_Url> manipulateInjectCode = _url -> _url;
        ...
        TGS_CallableType5<List<String>, String, String, Long, String, Boolean> libTableFileList_getFileNames_DataIn = (a, b, c, d, e) -> TGS_ListUtils.of();
        TGS_CallableType2<Path, String, String> libTableFileDir_datTblTblnameColname = (a, b) -> dirDatUsrTmp;
        TGS_CallableType2<TGS_Url, String, Boolean> libTableFileGetUtils_urlUsrTmp = (a, b) -> favIconPng;
        TGS_CallableType1<String, CharSequence> libTableServletUtils_URL_SERVLET_FETCH_TBL_FILE = a -> customDomain.toString();
        TGS_CallableType1<String, CharSequence> libFileServletUtils_URL_SERVLET_FETCH_PUBLIC = a -> customDomain.toString();
        TGS_CallableType1<String, CharSequence> libFileServletUtils_URL_SERVLET_FETCH_USER = a -> customDomain.toString();
        ...
        var result = TS_FileTmcrFileHandler.use(
                fileCommonBall,
                null,//TS_SQLConnAnchor anchor, 
                null,//<String, Integer> progressUpdate_with_userDotTable_and_percentage, 
                null,//<TS_FileTmcrFileHandler> exeBeforeZip, 
                null//<TS_FileTmcrFileHandler> exeAfterZip
        );
